...
<body class="bg-gray-50 ">
    ...
    <main class="min-h-screen flex flex-col md:flex-row items-center justify-center md:justify-evenly gap-8 p-6 md:p-10">
        ...
        <div class="order-1 md:order-2 flex items-center justify-center">
            <img src="../../../assets/svg/editUsers.svg" alt="editUser Illustration" class="w-64 md:w-96 lg:w-[500px] max-w-full h-auto">
        </div>
            ...
            <form action="./actions/update_user.php" method="post">
                ...
                <div class="relative mb-4">
                    ...
                    <div class="flex items-center border border-[#007a3f] rounded-lg overflow-hidden mt-1 focus-within:ring-2 focus-within:ring-[#007a3f] transition">
                        ...
                        <input type="text" name="nom" class="flex-1 py-3 pl-2 outline-none" placeholder="Ex: Ezzit" required value="<?= $user["nom"] ?>">
                    </div>
                </div>
                ...
                <div class="relative mb-4">
                    ...
                    <div class="flex items-center border border-[#007a3f] rounded-lg overflow-hidden mt-1 focus-within:ring-2 focus-within:ring-[#007a3f] transition">
                        <lord-icon src="../../../assets/animation/UserAnim.json" trigger="loop" colors="primary:#007a3f" style="width:24px;height:24px" class="ml-2"></lord-icon>
                        <input type="text" name="prenom" class="flex-1 py-3 pl-2 outline-none" placeholder="Ex: Mustapha" required value="<?= $user["prenom"] ?>">
                    </div>
                </div>
                <!-- Email -->
                <div class="relative mb-4">
                    ...
                    <div class="flex items-center border border-[#007a3f] rounded-lg overflow-hidden mt-1 focus-within:ring-2 focus-within:ring-[#007a3f] transition">
                        ...
                        <input type="email" name="email" class="flex-1 py-3 pl-2 outline-none" placeholder="exemple@gmail.com" required value="<?= $user["email"] ?>">
                    </div>
                </div>
                <!-- Rôle -->
                <div class="relative mb-4">
                ...
                <div class="relative mb-6 flex items-center gap-2">
                    <input type="checkbox" name="is_active" id="is_active" class="w-4 h-4 border border-gray-300 rounded text-[#007a3f] focus:ring-[#007a3f]" <?= $user['is_active'] === 1 ? 'checked' : '' ?>>
