...
<head>
  ...
  <title>EMSIContact - Modifier Utilisateur</title>
...
<div class="text-center flex flex-col items-center gap-2 mb-6 mt-24 ">
  ...
  <h1 class="text-3xl font-bold text-gray-800">Modifier un Utilisateur</h1>
</div>
  ...
  <div class="w-full max-w-md order-2 md:order-1 shadow-[10px_10px_0_#007a3f] border border-[#007a3f] rounded-2xl p-6 bg-white">
    <form action="./actions/update_user.php" method="post">
      ...
      <div class="relative mb-6 flex items-center gap-2">
        <input type="checkbox" name="is_active" id="is_active" class="w-4 h-4 border border-gray-300 rounded text-[#007a3f] focus:ring-[#007a3f]" <?= $user['is_active'] ? 'checked' : '' ?>>
